...
#
#  * I need to filter the Contacts table according to whether the contact is supplier or provider
#  * We need to filter for supplier to calculate costs, and to calculate new customers, filter by client.
#
#    STEPS:
...
#
# * In Holded there is the Cash info
#
#    STEPS:
#    • From df_ebitda
